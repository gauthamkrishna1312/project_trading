...
urlpatterns = [   
    ...
    path('moderator/payments/<str:status>', login_required(views.Admpayments_view.as_view()), name='adm_payments'),
    path('moderator/payments/action/<str:action>/<int:id>', login_required(views.Admpayments_view.as_view()), name="adm_payments_approve"),
    path('moderator/withdraw/<str:status>', login_required(views.Admwithdraw_view.as_view()), name='adm_withdraw'),
    path('moderator/withdraw/action/<str:action>/<int:id>', login_required(views.Admwithdraw_view.as_view()), name='adm_withdraw_action'),
